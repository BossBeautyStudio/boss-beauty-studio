    ...
    return (
      <LoginLayout>
        <div className="fade-in text-center">
          ...
          {/* Conseil anti-spam */}
          <div
            className="mb-8 flex items-start gap-3 rounded-xl px-4 py-3 text-left"
            style={{ backgroundColor: "var(--surface-alt)" }}
          >
            <svg
            ...
            <p className="text-xs leading-relaxed" style={{ color: "var(--text-muted)" }}>
              ...
              <span className="hidden sm:inline">
                Si tu ne vois pas l&apos;email, pense à vérifier tes spams et à ajouter
                Boss Beauty Studio à tes contacts pour recevoir les prochains messages correctement.
              </span>
              {/* Version mobile — plus courte */}
              <span className="sm:hidden">
                Tu ne vois pas l&apos;email&nbsp;? Vérifie tes spams et ajoute-nous à tes contacts.
              </span>
            </p>
          </div>
